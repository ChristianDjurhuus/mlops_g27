...
- [ ] (Christrian) Write one or multiple configurations files for your experiments
- [ ] (Christrian) Used Hydra to load the configurations and manage your hyperparameters
